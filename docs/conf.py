...
import re
filename = os.path.join(os.path.dirname(__file__), "..", "wc_env_manager", "_version.py")
...
addmetahtml_content = '<meta http-equiv="refresh" content="0; url=https://docs.karrlab.org/wc_env_manager" />'
